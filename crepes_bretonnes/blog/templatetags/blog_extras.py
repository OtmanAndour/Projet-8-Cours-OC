...
@register.filter(is_safe=True, name='mon_filtre_citation')
def citation(texte):
    """
...
@register.filter(is_safe=True, name='truncate')
...
class RandomNode(template.Node):
    ...
    def render(self, context):
        return ("Un nombre aléatoire entre " + str(self.begin) + " et " + str(self.end) + " est: " + str(randint(self.begin, self.end)))